...
Çok Girdili (Multi-Input) 1D-CNN Mimarisi: Sadece sayısal in silico skorlara (REVEL, CADD vb.) dayanmaz. Mutasyon bölgesindeki $\pm5$ komşuluktaki DNA nükleotidlerini (11x4) ve Amino Asit dizilimlerini (11x20) Bire-Bir Kodlama (One-Hot) ile matrislere çevirerek biyolojik motifleri doğrudan okur.
...
Dosya Yapısı
├── proje.ipynb   # Veri çekimi, ön işleme, model eğitimi ve eşik analizi notebook'u
...
Gereksinimler
Projenin sorunsuz çalışması için Python 3.8+ sürümü önerilir. Gerekli kütüphaneleri aşağıdaki komutla yükleyebilirsiniz:pip install pandas numpy scikit-learn tensorflow matplotlib seaborn requests pyfaidx
Çalıştırma Adımları
1.Depoyu bilgisayarınıza klonlayın.
2.hg38.fa (Referans Genom) ve clinvar.vcf.gz dosyalarının ana dizinde olduğundan emin olun.
3.Jupyter Notebook dosyasını (veri_ve_model_kodlari.ipynb) açın.
...
Not: NCBI ve MyVariant API'lerine yapılan toplu istekler zaman alabilir. Notebook içerisinde sunucuyu yormamak adına .sleep() fonksiyonları eklenmiştir.
Geliştirenler: Melda Kahraman & Ege ErtekinBu proje Gazi Üniversitesi Bilgisayar Mühendisliği Veri Bilimi dersi kapsamında geliştirilmiştir.
